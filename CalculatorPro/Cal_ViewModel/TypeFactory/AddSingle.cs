...
using Cal_ViewModel.JudgeFactory;

namespace Cal_ViewModel.Symbol
{
    public class AddSingle : Judge.IJudgeForSingle
    {
        ...
        public string JudgeForSinge(string single)
        {
            ...
            {
                Cache.underCache = CalViewModel._disPlayTextUnder;
                //Cache.resultCache = "";
                Cache.judgeTurn = true;
            ...
            switch (single)
            {
                ...
                case "±":
...

                    {
                        if (!Cache.judgeSinge)
                        {
                            Cache.topCache += ("negate(" + CalViewModel._disPlayTextUnder + ")");
                            Cache.underCache = CO.Minus(CalViewModel._disPlayTextUnder);
                            Cache.judgeSinge = true;
                        }
                        else
                        {
                            ...
                            if (str == "")
                            {
                                str = CalViewModel._disPlayTextUnder;
                            }
                ...
                case "%":
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if ("＋".Equals(Cache.operatorCacheNew) || "－".Equals(Cache.operatorCacheNew))
                            {
                                Cache.topCache = (Convert.ToDecimal(CalViewModel._disPlayTextUnder) * Convert.ToDecimal(CalViewModel._disPlayTextUnder) / 100).ToString();
                                Cache.underCache = (Convert.ToDecimal(CalViewModel._disPlayTextUnder) * Convert.ToDecimal(CalViewModel._disPlayTextUnder) / 100).ToString();
                                Cache.judgeSinge = true;
                            }
                            else if ("×".Equals(Cache.operatorCacheNew) || "÷".Equals(Cache.operatorCacheNew))
                            {
                                Cache.topCache = (Convert.ToDecimal(CalViewModel._disPlayTextUnder) / 100).ToString();
                                Cache.underCache = (Convert.ToDecimal(CalViewModel._disPlayTextUnder) / 100).ToString();
                                Cache.judgeSinge = true;
                            }
                        }
                    }
